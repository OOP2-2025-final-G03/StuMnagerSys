...
| メソッド | パス                | 内容        | 権限            |
| ---- | ----------------- | --------- | ------------- |
| GET  | /api/user        | ユーザー一覧・検索 | 教師 / スーパーユーザー |
| GET  | /api/user/detail | ユーザー詳細取得  | 全ユーザー         |
| POST | /api/user/create | ユーザー登録    | スーパーユーザー      |
| POST | /api/user/update | ユーザー情報更新  | スーパーユーザー      |
| POST | /api/user/delete | ユーザー削除    | スーパーユーザー      |

**学生管理 API（user/students）**
| メソッド | パス                | 内容        | 権限            |
| ---- | ----------------- | --------- | ------------- |
| GET  | /api/user/students | 学生一覧・条件検索 | 教師 / スーパーユーザー |


**科目管理 API（subject）**
| メソッド | パス                   | 内容        | 権限            |
| ---- | -------------------- | --------- | ------------- |
| GET  | /api/subject        | 科目一覧・条件検索 | 全ユーザー         |
| GET  | /api/subject/detail | 科目詳細取得    | 全ユーザー         |
| POST | /api/subject/create | 科目登録      | 教師 / スーパーユーザー |
| POST | /api/subject/update | 科目情報更新    | 教師 / スーパーユーザー |
| POST | /api/subject/delete | 科目削除      | 教師 / スーパーユーザー |

**選科管理 API（enrollment）**
| メソッド | パス                       | 内容        | 権限      |
| ---- | ------------------------ | --------- | ------- |
| POST | /api/enrollment/create  | 学生の科目登録   | 学生      |
| GET  | /api/enrollment/student | 学生の選科一覧取得 | 学生 / 教師 |
| POST | /api/enrollment/delete  | 学生の選科削除   | 教師      |

**成績管理 API（grade）**
| メソッド | パス                  | 内容       | 権限 |
| ---- | ------------------- | -------- | -- |
| GET  | /api/grade         | 成績検索     | 教師 |
| GET  | /api/grade/student | 学生成績一覧取得 | 学生 |
| POST | /api/grade/create  | 成績登録     | 教師 |
| POST | /api/grade/update  | 成績更新     | 教師 |
| POST | /api/grade/delete  | 成績削除     | 教師 |

**成績分析 API（analytics）**
| メソッド | パス                            | 内容            |
| ---- | ----------------------------- | ------------- |
| GET  | /api/analytic/grades/summary | 平均点・最高点・最低点算出 |
| GET  | /api/analytic/students       | 学生別成績分析       |
| GET  | /api/analytic/grades/chart   | グラフ表示用データ取得   |
| GET  | /api/analytic/grades/predict | 未来成績の予測       |
